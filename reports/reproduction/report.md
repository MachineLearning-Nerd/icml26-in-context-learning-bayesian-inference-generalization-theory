...
|---|---|---|---|---|
| [`audit/protected-judged-baseline`](https://github.com/MachineLearning-Nerd/icml26-in-context-learning-bayesian-inference-generalization-theory/tree/audit/protected-judged-baseline) | Freeze judged 5/10 evidence | `uv run --locked python repro/src/verify.py` | five historical TOY results | local CPU, 1 thread |
| [`audit/claim-1-risk-identity`](https://github.com/MachineLearning-Nerd/icml26-in-context-learning-bayesian-inference-generalization-theory/tree/audit/claim-1-risk-identity) | Exact risk identity | `uv run --locked python repro/src/verify.py` | VERIFIED | local CPU, 1 thread |
| [`audit/claim-5-uniform-attention`](https://github.com/MachineLearning-Nerd/icml26-in-context-learning-bayesian-inference-generalization-theory/tree/audit/claim-5-uniform-attention) | Actual Q=K=0 path | `uv run --locked python repro/src/verify.py` | VERIFIED | local CPU, 1 thread |
| [`audit/claim-3-posterior-concentration`](https://github.com/MachineLearning-Nerd/icml26-in-context-learning-bayesian-inference-generalization-theory/tree/audit/claim-3-posterior-concentration) | Universal concentration proof | `uv run --locked python repro/src/verify.py` | VERIFIED | local CPU, 1 thread |
| [`audit/claim-4-wasserstein-stability`](https://github.com/MachineLearning-Nerd/icml26-in-context-learning-bayesian-inference-generalization-theory/tree/audit/claim-4-wasserstein-stability) | Universal coupling proof | `uv run --locked python repro/src/verify.py` | VERIFIED | local CPU, 1 thread |
| [`audit/claim-2-cardinality-collision`](https://github.com/MachineLearning-Nerd/icml26-in-context-learning-bayesian-inference-generalization-theory/tree/audit/claim-2-cardinality-collision) | Exact counterexample | `uv run --locked python repro/src/verify.py` | FALSIFIED | local CPU, 1 thread |
